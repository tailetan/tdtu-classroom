...
<body>
    ...
    <div class="page-content py-3 pl-5 pr-3 bg-pink position-relative" id="header">
        ...
        <a class="d-inline text-pink ml-5 mt-2 mr-3 pt-1 position-absolute" href="<?php if($_SESSION['user_role']=='teacher'){echo '?';}else{echo '?mod=home&action=admin';} ?>" id="main-logo">
