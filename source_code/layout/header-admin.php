...
<body>
    ...
    <div class=" vertical-nav bg-white overflow-auto" id="sidebar">
        ...
        <form class=" mb-3  search-course-sidebar d-none" method="GET">
            <input class="form-control border-pink  rounded-pill  " type="search" name="admin-search-value" placeholder="Search Course" name="btn-search-course">
            <button class="btn btn-outline-search rounded-pill my-2  ml-2" name="admin-btn-search" type="submit">Search</button>
        </form>
        ...
        <p class="text-pink font-weight-bold text-uppercase px-3  pb-4 mb-0">All Courses</p>

        <ul class="nav flex-column bg-white mb-0" id="sidebar-class">
            <?php foreach ($list_all_class as $class) { ?>
                <li class="nav-item">
                    <a href="?mod=class&action=index&classid=<?php echo $class['class_id'] ?>" class="nav-link text-dark font-italic bg-light">
                        <?php echo $class['subject'] ?> - Room: <?php echo $class['room'] ?> - Lecturer: <?php echo $class['fullname'] ?>
                    </a>
                </li>
    ...
    <div class="page-content py-3 pl-5 pr-3 bg-pink position-relative" id="header">
        ...
        <a class="d-inline text-pink ml-5 mt-1 mr-3 pt-1 position-absolute" href="?mod=home&action=admin" id="main-logo">
            <img src="public/images/admin1.png" class="img-fluid" alt="Logo classroom">
            <!-- <h1 class="display-5"><i class="fas fa-book-open"></i> CLASSROOM </h1> -->
        </a>

        <!-- Search bar -->
        <form class="form-inline position-absolute" id="search-course" method="GET">
            <input class="form-control border-pink rounded-pill mr-sm-2" name="admin-search-value" type="search" placeholder="Search Course">
            <button class=" btn btn-outline-search rounded-circle my-2 my-sm-0" name="admin-btn-search" type="submit"><i class="fas fa-search"></i></button>
        </form>
