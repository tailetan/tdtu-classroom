...
<body id="delete-course-template">
    <!-- Vertical navbar -->
    <div class=" vertical-nav bg-white" id="sidebar">
        ...
        <h5 class="text-center ">
            <a class=" text-center text-pink" href="<?php if($_SESSION['user_role']=='teacher'){echo '?';}else{echo '?mod=home&action=admin';} ?>">
    ...
    <div class="page-content py-3 pl-5 pr-3 bg-pink position-relative" id="header">
        ...
        <a class="d-inline text-pink ml-5 mt-2 mr-3 position-absolute" href="<?php if($_SESSION['user_role']=='teacher'){echo '?';}else{echo '?mod=home&action=admin';} ?>" id="main-logo">
